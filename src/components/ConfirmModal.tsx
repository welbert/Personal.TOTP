...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 px-4 fade-in">
      <div className="bg-theme-surface border border-theme-border rounded-2xl w-full max-w-xs shadow-2xl p-5">
        <p className="text-sm text-theme-1 text-center mb-5">{message}</p>
